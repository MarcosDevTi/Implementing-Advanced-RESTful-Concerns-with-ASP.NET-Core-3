...
namespace CourseLibrary.API.Controllers
{
    ...
    public class AuthorsController : ControllerBase
    {
        ...
        [Consumes("application/json", "application/vnd.marvin.authorforcreationwithdateofdeath+json")]
        ...
        private IEnumerable<LinkDto> CreateLinksForAuthors(AuthorsResourceParameters authorsResourceParameters, bool hasNext, bool hasPrevious)
        {
            ...
            {
                links.Add(
               new LinkDto(CreateAuthorsResourceUri(authorsResourceParameters, ResourceUriType.NextPage), "nextPage", "GET"));
            }

            if (hasPrevious)
            {
                links.Add(
               new LinkDto(CreateAuthorsResourceUri(authorsResourceParameters, ResourceUriType.PreviousPage), "previousPage", "GET"));
            }
            return links;
        }
    }
